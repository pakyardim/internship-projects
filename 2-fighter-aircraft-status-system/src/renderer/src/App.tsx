  ...
  return (
    <main>
      <div className="container">
        <div className="left">
          <svg viewBox="0 0 800 800" xmlns="http://www.w3.org/2000/svg" version="1.0">
            <g transform={`rotate(${angle}, 360, 300)`}>
              <path
                className="plane-svg"
        ...
        <div className="right">
          ...
          >
            {battery < 75 && (
              <text x="200" y="100" fontFamily="Verdana" fontSize="36" fill="white">
                {battery < 20 && (
                  <animate
                    attributeType="XML"
                    attributeName="fill"
          ...
          <div className="svg-container">
            ...
            >
              ...
              <text x="420" y="932" fontFamily="Verdana" fontSize="64" fill="white">
                {speed}
              </text>
              <text x="420" y="1024" fontFamily="Verdana" fontSize="64" fill="white">
                KM/H
              </text>
            </svg>
            <svg
